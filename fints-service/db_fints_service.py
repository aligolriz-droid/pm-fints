...
# robust_mode AUS: die Bibliothek verschluckt sonst Parser-Fehler in der
# Bank-Antwort (z.B. im HNVSK-Sicherheits-Header) und gibt nur eine generische
# Warnung aus. Damit wir bei kryptischen Fehlern (wie bei DKB beobachtet) die
# ECHTE zugrunde liegende Exception in den Logs sehen, statt nur die Folgefehler.
try:
    import fints.parser as _fints_parser
    _fints_parser.robust_mode = False
except Exception:
    pass
